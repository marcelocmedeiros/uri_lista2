...
Se a média calculada for um valor entre 5.0 e 6.9, inclusive estas, o programa deve
...
(some a pontuação do exame com a média anteriormente calculada e divida por 2). e imprima
